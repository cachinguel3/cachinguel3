...
<div align="left">
  ...
  <img src="https://img.shields.io/badge/Oracle_PL%2FSQL-F80000?style=for-the-badge&logo=oracle&logoColor=white" alt="Oracle" />
</div>

#### **DevOps, Ferramentas & Workspace**
<div align="left">
...
#### **Desenvolvedor Voluntário | Lacrei Saúde**
* Atuação no desenvolvimento de soluções voltadas para a inclusão e acessibilidade na saúde.
* Trabalho colaborativo em equipe multi-funcional utilizando metodologias ágeis para entrega de software com impacto real.
* **Stack utilizada:** TypeScript, React, NextJS, Gatsby, Node.js e Jest.

---

### 🚀 Projetos em Destaque

#### 📝 [Todo List App](https://github.com/cachinguel3/ST-React-Introducao/tree/main/vite-project)
Uma aplicação clássica de gerenciamento de tarefas, com foco em uma interface limpa, reatividade e deploys ágeis.
- **Tecnologias:** React, Vite.
- **Deploy:** Hospedado na Vercel ([Ver Online](link-do-seu-projeto-na-vercel)).
